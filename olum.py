...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/olum_bot.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger('OlumBot')
...
# CLIENT TANIMI
client = TelegramClient('/root/0zctn/olum_bot_session', API_ID, API_HASH)
...
# Excel dosyası
EXCEL_FILE = "/root/0zctn/olum_data.xlsx"
