...
client = TelegramClient('sansar_bot', API_ID, API_HASH).start(bot_token=BOT_TOKEN)
    ...
    try:
        ...
        if not is_signal_active:
            if game_info['is_final'] and game_info.get('is_c2_3'):
                ...
                # 5.5 Alt/Üst sistemini her modda çalıştır (opsiyonel)
