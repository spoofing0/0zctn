...
client = None  # Client'ı global olarak tanımla
...
# Event handlers - bunları main fonksiyonu içinde kaydedeceğiz
...
# KOMUTLAR - bunları da main fonksiyonu içinde kaydedeceğiz
...
async def main():
    ...
    try:
        ...
        if os.path.exists('royal_bot.session'):
            os.remove('royal_bot.session')
