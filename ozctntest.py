...
async def quantum_hibrit_sistemi(game_info):
    ...
    if len(pattern_sonuclari) < 2:
        return print(f"🚫 Quantum: Yetersiz pattern çeşitliliği ({len(pattern_sonuclari)}/4)")
    ...
    if filtre_gecen < 5:
        return print(f"🚫 Quantum: Yetersiz filtre geçişi ({filtre_gecen}/6)")
...
async def quantum_pro_sistemi(game_info):
    ...
    if len(pattern_sonuclari) < 3:
        return print(f"🚫 Quantum PRO: Yetersiz pattern çeşitliliği ({len(pattern_sonuclari)}/6)")
    ...
    if filtre_gecen < 7:
        return print(f"🚫 Quantum PRO: Yetersiz filtre geçişi ({filtre_gecen}/8)")
...
async def master_elite_sistemi(game_info):
    ...
    if reason not in ELITE_PATTERNS:
        return print(f"🚫 Master Elite: {reason} elite değil")
    ...
    if filtre_gecen < 8:
        return print(f"🚫 Master Elite: Yetersiz filtre ({filtre_gecen}/{toplam_filtre})")
